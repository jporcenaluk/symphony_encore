...
| S05 | Issue and SystemJob lifecycle | In progress | Lane policy, deterministic eligibility/candidate ordering, a serialized/coalesced immediate tick trigger, exact reconciliation-first poll ordering, receipt-gated issue launch, atomic dispatch/closure, and bounded issue/repair outcome routing pass; live scheduler wiring and plan/review routes remain pending |
