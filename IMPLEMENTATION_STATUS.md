...
aggregate/profile/reference relationships. The generated summary below binds the human-authored
matrices to their reviewed registries, declared assessment bases, semantic digests, and derived
editorial counts. All three remain `legacy_mixed` and still require complete exact-revision evidence
reconciliation.
...
| Document | Current high-level gap assessment | Legacy-mixed planning matrix |
|---|---|---|
