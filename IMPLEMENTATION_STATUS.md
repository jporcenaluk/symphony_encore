...
| S17 | Codex app-server adapter | In progress | Exact normalized event/error contracts, immutable capability/profile/price manifest, ordered repo/home skill resolution, realpath containment, content hashing, and exact capability/skill preflight pass; current app-server protocol implementation awaits the newly installed OpenAI Docs MCP after restart |
